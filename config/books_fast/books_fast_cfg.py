...
Instances: all develop and validation parts from manually annotated books
...
# Classifier
timbl_ib_fname = "books_fast.ib"
timbl_inst_fname = "books_fast.inst"
timbl_opts = "-a1 +D"
timbl_log_fname = "books_fast_timbl_server_log.txt"
