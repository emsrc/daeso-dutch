...
"""
Graph aligner configuration for autocue-subtitle text using fast setting
...
Instances: all develop and validation parts from manually annotated autosub
corpus segment *plus* manually annotated new, where the "None" is 50% downsampled.
...
# Classifier
timbl_ib_fname = "autosub_fast.ib"
timbl_inst_fname = "autosub_fast.inst"
timbl_opts = "-a1 +D"
timbl_log_fname = "autosub_fast_timbl_server_log.txt"
